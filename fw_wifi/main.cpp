...
#define WIFI_STA_PIN 13
#define WIFI_SET_STA_PIN 14
#define WIFI_SET_AP_PIN 12
...
void setup() {
    ...
    // set STA/AP control pins
    gpio_init(WIFI_SET_STA_PIN);
    gpio_set_dir(WIFI_SET_STA_PIN, GPIO_OUT);
    gpio_put(WIFI_SET_STA_PIN, 0);
    gpio_init(WIFI_SET_AP_PIN);
    gpio_set_dir(WIFI_SET_AP_PIN, GPIO_OUT);
    gpio_put(WIFI_SET_AP_PIN, 1);
